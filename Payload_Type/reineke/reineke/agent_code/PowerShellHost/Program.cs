...
using ReinekeInterop.Serializers;
...
using ReinekeInterop.Constants;
...
namespace PowerShellHost
{
    class Program
    {
        ...
        private static void OnBufferWrite(object sender, ReinekeInterop.Classes.Events.StringDataEventArgs e)
        {
            if (e.Data != null)
            {
                try
