...
using ReinekeInterop.Types;
using ReinekeInterop.Enums.ApolloEnums;

namespace ReinekeInterop.Serializers
{
    public class JsonSerializer : ISerializer
    {
        ...
        public JsonSerializer()
        {
            ...
            //{
            //    if (t.FullName.StartsWith("ReinekeInterop.Structs.MythicStructs") || t.FullName.StartsWith("ReinekeInterop.Structs.ApolloStructs"))
            //    {
            //        _knownTypes.Add(t);
            //    }
            //}
