...
#region Cross AppDomain Loader
        static void ActivateLoader()
        {
            void OnWrite(object sender, object args)
            {
                ...
                Type tStringEventArgs = interop2.GetType("ReinekeInterop.Classes.Events.StringDataEventArgs");
            ...
            Type tWriter = interopAsm.GetType("ReinekeInterop.Classes.IO.EventableStringWriter");
