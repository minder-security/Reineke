...
namespace Tasks
{
    public class rm : Tasking
    {
        ...
        public rm(IAgent agent, ReinekeInterop.Structs.MythicStructs.MythicTask data) : base(agent, data)
        {
        }
        ...
        public override void Start()
        {
            ...
            if (ReinekeInterop.Utils.PathUtils.TryGetExactPath(path, out realPath))
            {
